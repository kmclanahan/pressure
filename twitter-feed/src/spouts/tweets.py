...
class Tweets(Spout):
    ...
    outputs = ['tweet', 'name', 'country', 'language', 'coords']
    ...
    def initialize(self, stormconf, context):
        ...
        stream.filter(locations=[-21.74,-37,54.55,36.89], async=True)
        ...
        try:
            ...
            if tweet:
                ...
                if tweet.place:
                    ...
                    self.emit([tweet.text, tweet.place.full_name, tweet.place.country, tweet.lang, tweet.place.bounding_box.coordinates])
